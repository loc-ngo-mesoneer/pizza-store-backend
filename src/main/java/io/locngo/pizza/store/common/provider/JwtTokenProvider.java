...
public class JwtTokenProvider {
    ...
    public String generateJwtToken(final UserPrincipal user) {
        ...
        return JWT.create()
                ...
                .withClaim(SecurityConstant.AUTHORITIES, this.extractAuthoritiesFromUser(user))
                .sign(this.algorithm);
    }
    ...
    private List<String> extractAuthoritiesFromUser(final UserPrincipal user) {
        ApiValidator.requireNonNull(user, "user");
